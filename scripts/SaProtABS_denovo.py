...
pdb_ls_path = "/home/jupyter-yehlin/ESM3_SaProt_dG/denovo/input_pdbs"  
...
# Save results to CSV
results_df.to_csv('/home/jupyter-yehlin/ESM3_SaProt_dG/denovo/model_predictions_denovo.csv', index=False)
print("\nResults saved to model_predictions_denovo.csv")